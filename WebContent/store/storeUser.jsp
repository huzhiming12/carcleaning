...
<body>
	...
	<div id="content">
		...
		<div class="inner">
			<form id="searchForm" action="AUser_storeUser" method="post">
				<div class="sou">
			...
			<form action="" class="addFrom">
				<p class="addP">卡号：</p>
				<input type="text" sort="int" id="userNo" maxlength="6" ismust="yes" class="addInp"
					placeholder="请输入卡号，卡号为6位数字" />
				<div class="error" sort="">*不能为空！</div>
				<p class="addP">姓名：</p>
				<input type="text" sort="ch" id="name" maxlength="5" ismust="no" class="addInp"
					placeholder="请输入姓名" />
				<div class="error" sort="">*不能为空！</div>
				<p class="addP">手机号：</p>
				<input type="text" sort="phone" id="phone" maxlength="11" ismust="yes" class="addInp"
					placeholder="请输入手机号" />
				<div class="error" sort="">*不能为空！</div>
				<p class="addP">车牌号：</p>
				<input type="text" sort="chepai" id="carNo" maxlength="7" ismust="yes" class="addInp"
					placeholder="请输入车牌号" />
				<div class="error" sort="">*不能为空！</div>
